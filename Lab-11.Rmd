...
In a Two Factor Between Subjcts ANOVA, a particlar participant is only ever in one condition or group or treatment level. 
...
For this, we willl use a new function called `tappy`. This applies a specified function to whatever variables you provide in the arguments. 
...
```{r}
plot(within_means,pch=19,xlab = "Treatments",ylab = "Survey Score",main = "Means of Survey Score by Treatment")
```
...
This particualr finding should be reported as follows:
