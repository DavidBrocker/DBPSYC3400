...
Herein lies the main difference between t-tests and ANOVAs: the amount of conditions (samples) that can be compared.

t-tests can only compare two conditions, while ANOVAs can compare more than two conditions.
